  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 mt-12 sm:mt-16 grid gap-14 lg:grid-cols-12 lg:gap-10 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.3} className="mt-10 flex flex-wrap gap-3">
              ...
              <Link href="/v2/services" className="btn-outline">
                Explore services
              </Link>
            </Reveal>
          </div>
      ...
      <nav
        ...
        className="sticky top-[100px] z-30 bg-ink/90 backdrop-blur border-b border-champagne-500/20"
      >
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid gap-8 lg:grid-cols-12 lg:items-end">
            ...
            <div className="lg:col-span-4 lg:text-right">
              <Reveal>
                <Link href="/v2/work" className="btn-outline">
