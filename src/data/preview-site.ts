// PREVIEW DATA — staged content for the proposed site update.
// This file is only consumed by /src/app/preview/* routes. On approval,
// merge these entries into src/data/site.ts and delete this file.

import type { Service } from './site';

/**
 * Proposed full service roster — 12 disciplines, ordered so the most
 * common booking paths come first and the strategic / platform offerings
 * close out the page.
 */
export const PREVIEW_SERVICES: Service[] = [
  {
...
export const PREVIEW_ENGAGEMENTS: EngagementTier[] = [
  {
    slug: 'advisory',
    title: 'Advisory',
...
/**
 * Lightweight credibility phrases shown on the new homepage in place of
 * hard numbers. Easy to swap to real stats once Vernique confirms them.
 */
export const PREVIEW_PROOF = [
